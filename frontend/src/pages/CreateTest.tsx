          ...
          <div className="space-y-3 mb-6 text-left">
            <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-4 flex items-center justify-between gap-3">
              ...
              <button
                ...
                className="shrink-0 inline-flex items-center gap-1.5 bg-primary-600 hover:bg-primary-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors"
              >
            ...
            <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-4 flex items-center justify-between gap-3">
              ...
              <button
                onClick={copyPinOnly}
                className="shrink-0 inline-flex items-center gap-1.5 bg-gray-700 hover:bg-gray-800 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors"
              >
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-10">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-base mt-1">Create a new test for your candidates</p>
      </div>
